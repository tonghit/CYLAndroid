...
var REQUEST_URL =
    "http://www.everyinch.net/virtual/cyl/data.json";
//import pct from "../pct"
...
const styles = StyleSheet.create({
    ...
    textOne:{borderColor:'#000',borderWidth:1,width:100,height:60,marginLeft:10,marginTop:5,resizeMode:'contain',},
    textTwo:{marginLeft:30,textAlign:'center',marginTop:20,fontSize:30,color:'#000'},
    list: {
