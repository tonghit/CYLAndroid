...
//import pct from "../pct"
export default class PracticeFourScreen extends Component<Props> {
    constructor(){
            super()
            this.state = {
                text: ''
            ...
            <View style={styles.schoolBackground}>
               <View>
                    <View style={styles.textOne}>
                        <Text style={styles.tOne}>1.（谮愬）的拼音是？</Text>
                    </View>
               ...
               <View>
                       <View style={styles.textOne}>
                           <Text style={styles.tOne}>2.（勿恃势力而凌逼孤寡）的下一句是？</Text>
                       </View>
                       <View style={styles.one}>
                           <RadioGroup onSelect = {(index, value) => this.onSelect(index, value)}>
                                 <RadioButton value={'item1'} >
                                     <Text>A    勿贪口腹而恣杀生禽</Text>
                                 </RadioButton>
                  ...
                  <View>
                          <View style={styles.textOne}>
                              <Text style={styles.tOne}>3.（乖僻自是，悔误必多）的下一句是？</Text>
                          </View>
                          <View style={styles.one}>
                              <RadioGroup onSelect = {(index, value) => this.onSelect(index, value)}>
                                    <RadioButton value={'item1'} >
                                        <Text>A    颓隳自甘，家道难成</Text>
                                    </RadioButton>
                     ...
                     <View>
                         <View style={styles.textOne}>
                             <Text style={styles.tOne}>4.谮愬的意思是？</Text>
                         </View>
                         <View style={styles.one}>
                             <RadioGroup onSelect = {(index, value) => this.onSelect(index, value)}>
                                   <RadioButton value={'item1'} >
                                       <Text>A    谗毁攻讦，挑拨离间</Text>
                                   </RadioButton>
